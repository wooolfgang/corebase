...
const defaultInputClassname = `border border-solid border-gray-500 rounded-sm border-0 px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:border-blue-800`
