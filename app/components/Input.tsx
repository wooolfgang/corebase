...
const defaultInputClassname = `font-serif border border-b-2 border-r-2 shadow-inner border-solid border-gray-500  border-0 px-2 py-0.5 text-base focus:outline-none focus:ring-2 focus:border-blue-800`
